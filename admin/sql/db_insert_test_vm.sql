...
VALUES
    -- Основные датчики
    ((SELECT "Id" FROM "SensorType" WHERE "SensorTypeName" = 'DOV'),    1, 'DOV_01',   'DOV_01',    'http://localhost:5055/api/Sensors/DOV', 30, true),
    ((SELECT "Id" FROM "SensorType" WHERE "SensorTypeName" = 'MUEKS'),    1, 'MUEKS_01',      'MUEKS_01',    'http://localhost:5055/api/Sensors/MUEKS', 30, true),
    ((SELECT "Id" FROM "SensorType" WHERE "SensorTypeName" = 'IWS'), 1, 'IWS_01',   'IWS_01', 'http://localhost:5055/api/Sensors/IWS', 30, true),
    ((SELECT "Id" FROM "SensorType" WHERE "SensorTypeName" = 'DUST'), 1, 'DUST_01',   'DUST_01', 'http://localhost:5055/api/Sensors/DUST', 30, true),    
    ((SELECT "Id" FROM "SensorType" WHERE "SensorTypeName" = 'DSPD'),    1, 'DSPD_01','DSPD_01','http://localhost:5055/api/Sensors/DSPD', 30, true)
