...
VALUES
    -- Основные датчики
    ((SELECT "Id" FROM "SensorType" WHERE "SensorTypeName" = 'DOV'),    1, 'DOV_01',   'DOV_01',    'http://192.168.3.43/json', 60, true),
    ((SELECT "Id" FROM "SensorType" WHERE "SensorTypeName" = 'MUEKS'),    1, 'MUEKS_01',      'MUEKS_01',    'http://192.168.3.42/json', 60, true),
    ((SELECT "Id" FROM "SensorType" WHERE "SensorTypeName" = 'IWS'), 1, 'IWS_01',   'IWS_01', 'http://192.168.3.45/json', 60, true),
    ((SELECT "Id" FROM "SensorType" WHERE "SensorTypeName" = 'DUST'), 1, 'DUST_01',   'DUST_01', 'http://46.23.183.51:8086/json', 60, true),    
    ((SELECT "Id" FROM "SensorType" WHERE "SensorTypeName" = 'DSPD'),    1, 'DSPD_01','DSPD_01','http://192.168.3.28/json', 60, true)
